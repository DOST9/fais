...
insert  into `tbl_lab`(`lab_id`,`labname`,`labcode`,`labcount`,`nextrequestcode`,`active`) values (1,'Chemical Laboratory','CHE',0,'',1),(2,'Microbiological Laboratory','MIC',0,'',1),(3,'Metrology Laboratory','MET',0,'',1),(4,'Physical Laboratory','PHY',0,'',1),(5,'Formula of Manufacture','FOC',0,'',1),(6,'Shelf Life Testing','SHL',0,'',0);
