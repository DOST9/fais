...
insert  into `tbl_auth_item_child`(`parent`,`child`) values ('access-accounting','/accounting/*'),('rbac-full-access','/admin/*'),('rbac-assign-permission','/admin/assignment/*'),('access-assignment','/admin/assignment/index'),('access-assignment','/admin/assignment/view'),('access-rbac','/admin/assignment/view'),('access-menu','/admin/menu/index'),('access-menu','/admin/menu/view'),('access-permission','/admin/permission/index'),('access-permission','/admin/permission/view'),('access-role','/admin/role/index'),('access-role','/admin/role/view'),('access-route','/admin/route/assign'),('access-route','/admin/route/index'),('access-rule','/admin/rule/index'),('access-rule','/admin/rule/view'),('access-user','/admin/user/*'),('access-cashiering','/cashiering/*'),('access-debug','/debug/*'),('access-gii','/gii/*'),('allow-gridview-export','/gridview/*'),('access-inventory','/inventory/*'),('access-lab','/lab/*'),('Guest','/maintenance/*'),('access-message','/message/*'),('access-package','/package/*'),('access-package','/package/createmodule'),('access-package','/package/export'),('access-package','/package/extract'),('access-package','/package/index'),('access-package','/package/removemodule'),('access-package','/package/upload'),('access-package','/package/writeini'),('profile-full-access','/profile/*'),('access-his-profile','/profile/create'),('access-his-profile','/profile/index'),('access-profile','/profile/index'),('access-his-profile','/profile/update'),('access-his-profile','/profile/uploadPhoto'),('profile-full-access','/profile/uploadPhoto'),('access-his-profile','/profile/view'),('access-profile','/profile/view'),('access-sample','/sample/*'),('access-settings','/settings/*'),('Guest','/site/*'),('access-signup','/site/signup'),('super-administrator','/site/signup'),('profile-full-access','/site/upload'),('access-tagging','/tagging/*'),('access-test','/test/*'),('access-test2','/test2/*'),('access-test3','/test3/*'),('access-tt','/tt/*'),('user-full-access','/user/*'),('super-administrator','access-accounting'),('super-administrator','access-assignment'),('super-administrator','access-cashiering'),('super-administrator','access-debug'),('super-administrator','access-gii'),('basic-role','access-his-profile'),('super-administrator','access-inventory'),('lab-manager','access-lab'),('super-administrator','access-lab'),('super-administrator','access-menu'),('basic-role','access-message'),('super-administrator','access-message'),('super-administrator','access-package'),('super-administrator','access-package-list'),('super-administrator','access-permission'),('profile-full-access','access-profile'),('super-administrator','access-profile'),('super-administrator','access-rbac'),('super-administrator','access-role'),('super-administrator','access-route'),('super-administrator','access-rule'),('super-administrator','access-settings'),('Guest','access-signup'),('super-administrator','access-signup'),('super-administrator','access-tagging'),('super-administrator','access-user'),('super-administrator','allow-access-backend'),('super-administrator','allow-gridview-export'),('super-administrator','can-delete-profile'),('super-administrator','profile-full-access'),('rbac-full-access','rbac-assign-permission'),('super-administrator','rbac-full-access'),('super-administrator','user-full-access');
...
insert  into `tbl_package`(`PackageID`,`PackageName`,`icon`,`created_at`,`updated_at`) values (21,'lab','fa fa-bookmark',1515397499,1515634107),(22,'inventory','fa fa-assistive-listening-systems',1515398542,1515575300),(23,'tagging','fa fa-tag',1515475587,1515575270);
