...
class Profile extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return [
            [['lastname', 'firstname', 'designation', 'division_id', 'lab_id'], 'required'],
            [['user_id'],'required','message'=>'Please select Username!'],
            [['user_id', 'division_id', 'lab_id'], 'integer'],
            ...
            [['division_id'], 'exist', 'skipOnError' => true, 'targetClass' => Rstl::className(), 'targetAttribute' => ['rstl_id' => 'rstl_id']],
